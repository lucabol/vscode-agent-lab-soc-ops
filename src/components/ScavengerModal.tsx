  ...
  return (
    <div className="fixed inset-0 bg-mono-950/60 flex items-center justify-center p-6 z-50">
      <div className="bg-mono-50 border-2 border-mono-900 p-8 max-w-xs w-full text-center">
        ...
        <h2 className="text-2xl font-medium text-mono-950 mb-2 tracking-tight uppercase">Complete</h2>
        <p className="text-mono-600 mb-8 text-xs uppercase tracking-wider">All items found</p>
